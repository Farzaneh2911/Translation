...
const FeaturesList = () => {
  return (
    <Box sx={{
        ...
        <Grid container spacing={2} justifyContent="center" sx={{ maxWidth: 1200, mx: 'auto', mt:5, mb:5 }}>  
            ...
            <Grid item xs={12} sm={6} md={4} key={index}>
              <Box sx={{ display: 'flex', flexDirection: 'row', alignItems: 'start', px: 1 }}>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'start' }}>
                  <Typography variant="subtitle1" sx={{ fontWeight: 'bold', color: 'black', fontSize: '1.5rem' }}>
                    {feature.title}
                  </Typography>
